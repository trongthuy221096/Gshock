    ...
    <div id="page-inner">
        ...
        <hr />
             <%
	        	...
	        	if(watch!=null){
	        		name = watch.getName();
	        		detailtext = watch.getDetailtext();
	        		feature = watch.getFeature();
	        		parameters = watch.getParameters();
	        		sell =Integer.toString(watch.getSell());
	        		selloff =Integer.toString(watch.getSelloff());
	        		catid = watch.getCatid();
	        	}
                                ...
                                <form role="form" method="post" enctype="multipart/form-data" id="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="category" name="category" class="form-control">                    
	                                        ...
	                                        %>
	                                         <option <%if( catid==cat.getId()){out.print(" selected ");}%>value="<%=cat.getId()%>"><%=cat.getName() %></option>
	                                      <%}} %>
                                        </select>
                                    </div>
